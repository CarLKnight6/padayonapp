...
class _UserNoteListState extends State<UserNoteList>
  ...
  void incrementalCounter({int? count}) {
    setState(() {
      moodcounter = moodcounter + count!;
    });
  }
  ...
  updateprioritylist() {
    ...
    //forprioritylistcode
    for (var k in catMap.keys) {
      print("Key : $k, value : ${catMap[k]!.toInt()}");
      newBook[k] = catMap[k]!.toInt();
    }
