...
class DatePickerState extends State<DatePicker> {
  ...
  Future _sNotification(DateTime scheduledTime, int id) async {
    var androidDetails = new AndroidNotificationDetails("1", "padayon",
        icon: "app_icon", importance: Importance.max, enableVibration: true);
                          ...
                          Switch(
                            ...
                            onChanged: (value) {
                              setState(() {
                                ...
                                if (value) {
                                  _sNotification(
                                      alarms[reminders?.indexOf(item) ?? 0][2],
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  editReminder(reminders?.indexOf(item) ?? 0);
                                }),
                            IconButton(
                                color: Colors.purple[900],
                                icon: Icon(
                                ...
                                onPressed: () {
                                  editDate(
                                      context, reminders?.indexOf(item) ?? 0);
                                }),
                            IconButton(
                                color: Colors.purple[900],
                                icon: Icon(
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                cancelNotification(
                                    alarms[reminders?.indexOf(item) ?? 0][3],
                                    reminders?.indexOf(item) ?? 0);
                              },
                            ),
                          ],
